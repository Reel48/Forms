  ...
  return (
    <div className="container">
      ...
      {role === 'admin' && selectedForms.size > 0 && (
        <div className="card mb-4" style={{ backgroundColor: 'rgb(209 250 229)', borderColor: 'rgb(16 185 129)', padding: '1rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              <span style={{ fontWeight: '500', color: 'rgb(16 185 129)' }}>
                ...
                <tr key={form.id}>
                  ...
                  <td className="mobile-name-column">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                      <Link to={`/forms/${form.id}`} style={{ color: 'rgb(16 185 129)', textDecoration: 'none', fontWeight: '500' }}>
