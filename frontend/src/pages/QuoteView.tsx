                ...
                <div style={{ display: 'flex', borderBottom: '1px solid #e5e7eb', flexWrap: 'wrap' }}>
                  <button
                    ...
                    style={{
                      ...
                      background: 'none',
                      cursor: 'pointer',
                      borderBottom: activeTab === 'details' ? '2px solid rgb(59 130 246)' : '2px solid transparent',
                      color: activeTab === 'details' ? 'rgb(59 130 246)' : 'var(--color-text-muted)',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: 'none',
                      cursor: 'pointer',
                      borderBottom: activeTab === 'activities' ? '2px solid rgb(59 130 246)' : '2px solid transparent',
                      color: activeTab === 'activities' ? 'rgb(59 130 246)' : 'var(--color-text-muted)',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: 'none',
                      cursor: 'pointer',
                      borderBottom: activeTab === 'comments' ? '2px solid rgb(59 130 246)' : '2px solid transparent',
                      color: activeTab === 'comments' ? 'rgb(59 130 246)' : 'var(--color-text-muted)',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: 'none',
                      cursor: 'pointer',
                      borderBottom: activeTab === 'versions' ? '2px solid rgb(59 130 246)' : '2px solid transparent',
                      color: activeTab === 'versions' ? 'rgb(59 130 246)' : 'var(--color-text-muted)',
                  ...
                  {quote?.client_id && (
                    <button
                      ...
                      style={{
                        ...
                        background: 'none',
                        cursor: 'pointer',
                        borderBottom: activeTab === 'client-history' ? '2px solid rgb(59 130 246)' : '2px solid transparent',
                        color: activeTab === 'client-history' ? 'rgb(59 130 246)' : 'var(--color-text-muted)',
                            ...
                            <div style={{ flex: 1 }}>
                              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                                <Link 
                                  ...
                                  style={{ fontWeight: '600', color: 'rgb(59 130 246)', textDecoration: 'none' }}
